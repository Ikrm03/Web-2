...
<legend class="float-none w-auto px-3 fw-bold h3">Form Registrasi IT Club Data Science</legend>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="nim" name="nim" placeholder="Masukan NIM" type="text" class="form-control" required="required" pattern="[0-9]{10}" title=NIM>
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="nama_lengkap" name="nama_lengkap" placeholder="Masukan Nama Lengkap" type="text" class="form-control" required="required" minlength="3" maxlength="50">
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="custom-control custom-radio custom-control-inline">
        <input name="jenis_kelamin" id="jenis_kelamin_0" type="radio" class="custom-control-input" value="rabbit" required="required"> 
  ...
  <div class="form-group row">
    <label class="col-4">Skill Web & Pemrograman</label> 
    <div class="col-8">
    <?php
